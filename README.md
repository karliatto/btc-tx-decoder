# Bitcoin transactions decoder

The porpouse of this project is to create a simple transactions decoder from raw transaction to a JSON.
...
The result of the above raw transaction should be as below:
